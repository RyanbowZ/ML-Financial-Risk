...
qh=pd.read_csv("qhwconcat.csv",index_col="time")
...
for Model in range(1,12):
    ...
    if Model==1:
        ...
        clf=MLPClassifier(alpha=0.02,max_iter=500)
...
pd.DataFrame(d).to_csv('week_SumModelResult3.csv')
qh['y_real']=train_y
qh.to_csv('y_week_result_compare3.csv')
