...
qd=pd.read_csv('qhwnorm.csv',index_col="time")
...
qd['y3']=l3
qd['y4']=l4
qd.to_csv('qhwpcaresult.csv')'''

qh=pd.read_csv('qhwpcaresult.csv',index_col='time')[['y1','y2','y3','y4']]
k=4
...
pd.DataFrame(l).to_csv('qhwconcat.csv')