...
ys = pd.read_csv("D:\Documents\毕业设计\data\hs300.csv",index_col="time")[["val","ml","mla","theta","cc"]]

x1s = pd.read_csv("D:\Documents\毕业设计\data\qh.csv")[["time","per","lncjl","lncjje","jc","lnccl"]]
